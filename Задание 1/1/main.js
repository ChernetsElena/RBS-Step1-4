var data = [
	{ id: 1, title: "The Shawshank Redemption", year: 1994, votes: 678790, rating: 7.2, rank: 1 },
	{ id: 2, title: "The Godfather", year: 1972, votes: 511495, rating: 9.2, rank: 2 },
	{ id: 3, title: "The Godfather: Part II", year: 1974, votes: 319352, rating: 6.0, rank: 3 },
	{ id: 4, title: "The Good, the Bad and the Ugly", year: 1966, votes: 213030, rating: 8.9, rank: 4 },
	{ id: 6, title: "12 Angry Men", year: 1957, votes: 164558, rating: 8.9, rank: 6 },
	{ id: 5, title: "My Fair Lady", year: 1964, votes: 533848, rating: 9.9, rank: 5 }
];
...
function sortByRating(data) {
	...
	for (let j = 0; j < sortedData.length; j++){
		let max = 0;
		let index = 0;
		for (let i = j; i < sortedData.length; i++){
			if (sortedData[i].rating > max){
				max = sortedData[i].rating;
				index = i;
			}
		}
		saveElement = sortedData[j];
		sortedData.splice(j, 1, sortedData[index])
		sortedData.splice(index, 1, saveElement)
